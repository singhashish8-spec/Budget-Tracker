...
function CsvReviewStep({ imported, source, categories, editingId, setEditingId, onPick, onBack, onConfirm }) {
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', padding: 'calc(env(safe-area-inset-top, 0px) + 74px) 16px 120px', display: 'flex', flexDirection: 'column', gap: 12, position: 'relative', minHeight: 0 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '0 4px' }}>
